...
- (id)initWithDelegate:(id)d {
    ...
    if (self) {
        ...
        self.tokenKindTab[@">="] = @(EXPRESSIONPARSER_TOKEN_KIND_GE);
        self.tokenKindTab[@","] = @(EXPRESSIONPARSER_TOKEN_KIND_COMMA);
        self.tokenKindTab[@"or"] = @(EXPRESSIONPARSER_TOKEN_KIND_OR);
        self.tokenKindTab[@"<"] = @(EXPRESSIONPARSER_TOKEN_KIND_LT);
        self.tokenKindTab[@"<="] = @(EXPRESSIONPARSER_TOKEN_KIND_LE);
        self.tokenKindTab[@"="] = @(EXPRESSIONPARSER_TOKEN_KIND_EQ);
        self.tokenKindTab[@"."] = @(EXPRESSIONPARSER_TOKEN_KIND_DOT);
        self.tokenKindTab[@">"] = @(EXPRESSIONPARSER_TOKEN_KIND_GT);
        self.tokenKindTab[@"("] = @(EXPRESSIONPARSER_TOKEN_KIND_OPENPAREN);
        self.tokenKindTab[@"yes"] = @(EXPRESSIONPARSER_TOKEN_KIND_YES);
        self.tokenKindTab[@"no"] = @(EXPRESSIONPARSER_TOKEN_KIND_NO);
        self.tokenKindTab[@")"] = @(EXPRESSIONPARSER_TOKEN_KIND_CLOSEPAREN);
        self.tokenKindTab[@"!="] = @(EXPRESSIONPARSER_TOKEN_KIND_NE);
        self.tokenKindTab[@"and"] = @(EXPRESSIONPARSER_TOKEN_KIND_AND);

        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_GE] = @">=";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_COMMA] = @",";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_OR] = @"or";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_LT] = @"<";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_LE] = @"<=";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_EQ] = @"=";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_DOT] = @".";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_GT] = @">";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_OPENPAREN] = @"(";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_YES] = @"yes";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_NO] = @"no";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_CLOSEPAREN] = @")";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_NE] = @"!=";
        self.tokenKindNameTab[EXPRESSIONPARSER_TOKEN_KIND_AND] = @"and";
...
- (void)__relOp {
    ...
    if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_LT, 0]) {
        [self lt_]; 
    } else if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_GT, 0]) {
        [self gt_]; 
    } else if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_EQ, 0]) {
        [self eq_]; 
    } else if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_NE, 0]) {
        [self ne_]; 
    } else if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_LE, 0]) {
        [self le_]; 
    } else if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_GE, 0]) {
        [self ge_]; 
    } else {
...
- (void)__primary {
    ...
    if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_NO, EXPRESSIONPARSER_TOKEN_KIND_YES, TOKEN_KIND_BUILTIN_NUMBER, TOKEN_KIND_BUILTIN_QUOTEDSTRING, TOKEN_KIND_BUILTIN_WORD, 0]) {
        [self atom_]; 
    } else if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_OPENPAREN, 0]) {
        [self openParen_]; 
        [self expr_]; 
        [self closeParen_]; 
    } else {
...
- (void)__atom {
    ...
    if ([self predicts:TOKEN_KIND_BUILTIN_WORD, 0]) {
        [self obj_]; 
    } else if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_NO, EXPRESSIONPARSER_TOKEN_KIND_YES, TOKEN_KIND_BUILTIN_NUMBER, TOKEN_KIND_BUILTIN_QUOTEDSTRING, 0]) {
        [self literal_]; 
    } else {
...
- (void)__literal {
    ...
    if ([self predicts:TOKEN_KIND_BUILTIN_QUOTEDSTRING, 0]) {
        ...
        [self matchNumber:NO]; 
    } else if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_NO, EXPRESSIONPARSER_TOKEN_KIND_YES, 0]) {
        [self bool_]; 
    } else {
...
- (void)__bool {
    ...
    if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_YES, 0]) {
        [self yes_]; 
    } else if ([self predicts:EXPRESSIONPARSER_TOKEN_KIND_NO, 0]) {
        [self no_]; 
    } else {
...
- (void)__lt {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_LT discard:NO]; 
...
- (void)__gt {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_GT discard:NO]; 
...
- (void)__eq {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_EQ discard:NO]; 
...
- (void)__ne {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_NE discard:NO]; 
...
- (void)__le {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_LE discard:NO]; 
...
- (void)__ge {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_GE discard:NO]; 
...
- (void)__openParen {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_OPENPAREN discard:NO]; 
...
- (void)__closeParen {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_CLOSEPAREN discard:YES]; 
...
- (void)__yes {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_YES discard:NO]; 
...
- (void)__no {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_NO discard:NO]; 
...
- (void)__comma {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_COMMA discard:NO]; 
...
- (void)__or {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_OR discard:NO]; 
...
- (void)__and {
    ...
    [self match:EXPRESSIONPARSER_TOKEN_KIND_AND discard:NO]; 
