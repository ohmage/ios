...
//TODO: change back (also bundle id and url scheme
//NSString * const kOhmageGoogleClientID = @"48636836762-84uv0p5vh2faho7k7fv4230pcgff35d5.apps.googleusercontent.com";//old
...
NSString * const kOhmageDSUClientID = @"org.openmhealth.ios.ohmage"; //io.smalldatalab.ohmage
